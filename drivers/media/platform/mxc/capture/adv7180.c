...
#define ADV7180_HUE            		0x0b	/* Brightness */
...
static int ioctl_g_ifparm(struct v4l2_int_device *s, struct v4l2_ifparm *p)
{
	...
	p->u.bt656.bt_sync_correct = 1;
        ...
        p->u.bt656.clock_curr = 28000000;

        //adv7180_write_reg(0x00,0x00); //Input Control - force cvbs
        //adv7180_write_reg(0x1d,0x40); //ADI Control 2
        //adv7180_write_reg(0x31,0x1a); //VSync Field Control 1 
        //adv7180_write_reg(0x7b,0x00); //CP AV Control
...
static int ioctl_s_parm(struct v4l2_int_device *s, struct v4l2_streamparm *a)
{
	...
	/* These are all the possible cases. */
	case V4L2_BUF_TYPE_VIDEO_CAPTURE:
		adv7180_write_reg(0x00, (unsigned char)a->parm.output.outputmode);
        adv7180_write_reg(0x1d,0x40); //ADI Control 2
        adv7180_write_reg(0x31,0x1a); //VSync Field Control 1 
        adv7180_write_reg(0x7b,0x00); //CP AV Control
	case V4L2_BUF_TYPE_VIDEO_OUTPUT:
...
static int ioctl_s_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_HUE:
		dev_dbg(&adv7180_data.sen.i2c_client->dev,
			"   V4L2_CID_HUE\n");
		tmp = vc->value;
		adv7180_write_reg(ADV7180_HUE, tmp);
		adv7180_data.sen.hue = vc->value;
		break;
	case V4L2_CID_AUTO_WHITE_BALANCE:
		dev_dbg(&adv7180_data.sen.i2c_client->dev,
			"   V4L2_CID_AUTO_WHITE_BALANCE\n");
